...
--
-- Name: appointments_services_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.appointments_services_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.appointments_services_id_seq OWNER TO freecodecamp;

--
-- Name: appointments_services_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.appointments_services_id_seq OWNED BY public.appointments.service_id;
...
ALTER TABLE ONLY public.appointments ALTER COLUMN service_id SET DEFAULT nextval('public.appointments_services_id_seq'::regclass);
...
--
-- Name: appointments_services_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.appointments_services_id_seq', 1, false);
